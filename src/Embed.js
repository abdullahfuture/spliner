...
const navigation = [// navbar section 
  { label: 'Product', href: '#' },// ref to the same page 
  { label: 'Features', href: '#' },// ref to the same page 
  { label: 'Marketplace', href: '#' },// ref to the same page 
  { label: 'Company', href: '#' },// ref to the same page 
] // if you want to use this library to write your code easier go to : https://headlessui.com/
            ...
            <div className="flex items-center flex-1">
              <div className="flex items-center justify-between w-full">
                <a href="#">
                  ...
                  <img className="w-auto h-10" src="/public/%PUBLIC_URL%/favicon.ico" alt="" />
                </a>
              ...
              <div className="hidden space-x-8">
                {navigation.map((item) => (
                  <a key={item.label} href={item.href} className="text-base font-medium text-white hover:text-gray-300">
                    {item.label}
                  </a>
                ))}
              </div>
          ...
          <Popover.Panel focus className="absolute z-10 top-0 inset-x-0 p-4 transition transform origin-top">
            <div className="rounded-3xl shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
              <div className="px-5 pt-4 flex items-center justify-between">
                <div>
                  <img className="h-8 w-auto" src="/public/%PUBLIC_URL%/favicon.ico" alt="" />
                </div>
                <div className="-mr-2">
              ...
              <div className="pt-5 pb-6">
                <div className="px-2 space-y-1">
                  {navigation.map((item) => (
                    <a key={item.label} href={item.href} className="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">
                      {item.label}
                    </a>
                  ))}
                </div>
              ...
              <div className="mx-auto max-w-md px-4 max-w-2xl px-6 text-center">
                <div className="">
                  ...
                  <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white mt-5 text-6xl">
                    ...
                    <span className="block text-indigo-400">design spline apps</span>
                  </h1>
                  <p className="mt-3 text-base text-gray-300 mt-5 text-xl">
                  spline design is a powerful tool for creating smooth curves that accurately represent complex data, and it plays a critical role in many technical fields.
                  </p>
                ...
                <div className="max-w-7xl mx-auto px-6">
                  <div className="relative shadow-xl rounded-2xl overflow-hidden">
                    ...
                    <div className="relative px-4 py-16 px-6 py-24">
                      ...
                      Controlling customer support is vital for business success in a competitive market. Effective strategy and tools enable companies to provide exceptional service, differentiate themselves from competitors, and achieve long-term success.
                      </p>
